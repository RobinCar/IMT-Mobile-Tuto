 ...
 *
 */
const BoutonAction = ({ nom, action, functionPress }) => (
    <TouchableHighlight
        underlayColor='#efefef'
        style={styles.bouton}
        onPress={functionPress} >
        <Text style={(nom == "Supprimer") ? styles.supprimer : (nom == "Terminer") && (action.isTerminated == true) ? styles.termine : styles.texte}>
            {nom}
        </Text>
    </TouchableHighlight>
)
