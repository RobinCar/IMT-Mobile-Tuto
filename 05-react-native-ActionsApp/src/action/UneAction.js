 ...
 */
const UneAction = ({ action, updateTerminated, deleteAction }) => (
    <View style={styles.conteneurUneAction}>
        <Text style={styles.texteUneAction}>
            {action.title}
        </Text>
        <View style={styles.boutons}>
            <BoutonAction functionPress={updateTerminated} action={action} nom="Terminer"></BoutonAction>
            <BoutonAction functionPress={deleteAction} action={action} nom="Supprimer"></BoutonAction>
        </View>
    </View>
)
